...
public class TextureUtils {
    ...
    /**
     * Makes a texture from any bitmap. (Texture should have size that is power
     * of 2)
     * 
     * @param bmp
     *            bitmap
     * @return BitmapDrawable that has size that is power of 2. Bitmap is not
     *         stretched, free space is filled with default color.
     */
