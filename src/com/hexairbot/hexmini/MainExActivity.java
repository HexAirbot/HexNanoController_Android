...
public class MainExActivity extends FragmentActivity implements OnIpcConnectChangedListener, 
	SettingsDialogDelegate, OnTouchListener, HudViewControllerDelegate {
...
//    	this.startActivity(intent);
    ...
    private void startControllerActiviy() {
		...
		Intent intent = new Intent();
		intent.setClass(MainExActivity.this, HudActivity.class);
		this.startActivity(intent);
    }
